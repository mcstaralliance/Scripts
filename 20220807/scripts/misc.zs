...
mods.avaritia.ExtremeCrafting.addShaped("resource_5", <avaritia:resource:5>, [
    ...
    [<enderio:block_alloy:6>,<ic2:resource:8>,<thermalfoundation:storage_alloy:7>,<avaritia:singularity:11>, <thaumadditions:adaminite_block>, <extrabotany:blockorichalcos>, <extraplanets:tier11_items:4>],
