...
//林业背包
val bags = [<forestry:lepidopterist_bag>,<forestry:miner_bag>,<forestry:digger_bag>,<forestry:forester_bag>,<forestry:hunter_bag>,<forestry:apiarist_bag>,<forestry:adventurer_bag>,<forestry:builder_bag>]
for i, bag in bags {
    val bag = bags[i];
    recipes.remove(bag);
}
