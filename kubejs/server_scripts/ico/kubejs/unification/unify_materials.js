onEvent('recipes', (event) => {
    ...
    function magical_ore_processing(
        ...
        event
            ...
            .id(`ico:magical_ore_processing/mana/${material}`);
        ...
        event
            ...
            .id(`ico:magical_ore_processing/lightning/${material}`);
        ...
        event
            ...
            .id(`ico:magical_ore_processing/aura/${material}`);
        ...
        event
            ...
            .id(`ico:magical_ore_processing/starlight/${material}`);
        ...
        event.recipes.bloodmagic
            ...
            .consumptionRate(18)
            .drainRate(9)
            .id(`ico:magical_ore_processing/blood/${material}`);
    }
});
