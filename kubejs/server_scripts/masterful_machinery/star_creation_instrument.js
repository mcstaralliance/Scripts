    ...
    const recipes = [
        {
            outputs: [
                ...
                { type: 'masterfulmachinery:items', data: { item: 'minecraft:coal_ore', count: 12 } },
                ...
                { type: 'masterfulmachinery:items', data: { item: 'thermal:cinnabar_ore', count: 7 } },
                ...
                { type: 'masterfulmachinery:items', data: { item: 'gobber2:gobber2_ore', count: 8 } },
                { type: 'masterfulmachinery:items', data: { item: 'gobber2:gobber2_ore_nether', count: 4 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:quartz_ore', count: 5 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:charged_quartz_ore', count: 5 } },
