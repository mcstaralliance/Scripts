...
onEvent('item.tooltip', tooltip => {
    ...
    tooltip.add('masterfulmachinery:particle_fusion_reactor_controller', ['§e多方块名§f : §a星域粒子聚合器', '§e需要：', '§c星域粒子聚合器物品输入口 * 1', '§c星域粒子聚合器能量输入口 * 6', '§c并行处理单元 * 2', '§c流明玻璃 * 96', '§c琥珀金块 * 8', '§c福鲁伊克斯块 * 6', '§c守护之石 * 3', '§c致密能量元件 * 2', '§c星域粒子聚合器物品输出口 * 1', '§c高级原液单元 * 2', '§d§lDesigned by Tudor'])
    ...
    tooltip.add(['botania:mana_pool', 'botania:diluted_pool', 'botania:fabulous_pool', 'botania:creative_pool', 'extrabotany:manabuffer'], '放下后右键可查看其剩余魔力')
    tooltip.add(['pipez:item_pipe'], ['§e物品: 4 / 20ticks'])
    tooltip.add(['pipez:fluid_pipe'], ['§b流体: 50mB / tick'])
    tooltip.add(['pipez:energy_pipe'], ['§c能量: 256FE / tick'])
    tooltip.add(['pipez:universal_pipe'], ['§e物品: 4 / 20ticks', '§b流体: 50mB / tick', '§c能量: 256FE / tick'])
    tooltip.add(['pipez:basic_upgrade'], ['§e物品: 8 / 15ticks', '§b流体: 100mB / tick', '§c能量: 1024FE / tick'])
    tooltip.add(['pipez:improved_upgrade'], ['§e物品: 16 / 10ticks', '§b流体: 500mB / tick', '§c能量: 8192FE / tick'])
    tooltip.add(['pipez:advanced_upgrade'], ['§e物品: 32 / 5ticks', '§b流体: 2000mB / tick', '§c能量: 32768FE / tick'])
    tooltip.add(['pipez:ultimate_upgrade'], ['§e物品: 64 / tick', '§b流体: 10000mB / tick', '§c能量: 131072FE / tick'])
    tooltip.add(['pipez:infinity_upgrade'], ['§e物品: 2147483647 / tick', '§b流体: 2147483647mB / tick', '§c能量: 2147483647FE / tick'])
    tooltip.add(['#xnet:connectors'], ['§e物品: 64 / 10ticks', '§b流体: 1000mB / 20ticks', '§c能量: 50000FE / tick'])
    tooltip.add(['#xnet:advanced_connectors'], ['§e物品: 64 / 5ticks', '§b流体: 5000mB / 10ticks', '§c能量: 500000FE / tick'])
})