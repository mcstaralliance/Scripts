...
onEvent('item.tooltip', tooltip => {
    ...
    tooltip.add('masterfulmachinery:machine_pulverizer_controller', ['§e多方块名§f : §a模块化粉碎机', '§e需要：', '§c注意危险 * 12', '§c石英粉碎机 * 9', '§c硬化玻璃 * 9', '§c模块化粉碎机物品输入 + 输出口 * 1', '§c模块化粉碎机能量输入口 * 1', '§c下界合金机械方块 * 46', '§c下界合金包层铝传输通道', '§c工厂警示块 * 24', '§d§lDesigned by qing_kong'])
    ...
    tooltip.add('masterfulmachinery:material_stonework_factory_controller', ['§e多方块名§f : §a模块化造石厂', '§e需要：', '§c工厂灯块 * 5', '§c金块 * 5', '§c模块化造石厂流体输入口 * 2', '§c钢瓦块 * 25', '§c模块化造石厂物品输入口 * 2', '§c工厂警示块 * 13', '§c高压线圈 * 2', '§c通风管道 * 5', '§d§lDesigned by qing_kong'])
    ...
    tooltip.add('masterfulmachinery:star_creation_instrument_controller', ['§e多方块名§f : §a创星仪', '§e需要：', '§c信标 * 1', '§c彩虹桥玻璃 * 1', '§c暗黑玻璃 * 1', '§c黑曜石反应堆基底 * 617', '§c中子素反应堆外壳 * 120', '§c星灵中子机械方块* 232', '§c高压危险 * 72', '§c夸克级承重方块 * 18', '§c质量压力容器 * 112', '§c星辰之耀线圈 * 209', '§c维度外壳 * 149', '§c末影玻璃 * 248', '§c中子素质量通道 * 32', '§c下界之星能量块 * 97', '§c星辉块 * 14', '§c精灵钢块 * 12', '§c星灵中子响应器 29 * 28', '§c下界之星块 * 1', '§c夸克计算力场方块 * 12', '§c星灵中子聚合器 * 24', '§c创星仪能量输出 + 输入口 * 2', '§c创星仪流体输出 + 输入口 * 2', '§c创星仪物品输出 + 输入口 * 2', '§d§lDesigned by qing_kong'])
